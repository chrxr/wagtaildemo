...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BlogPageCarouselItem.image_title'
        db.add_column(u'demo_blogpagecarouselitem', 'image_title',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'BlogPageCarouselItem.image_caption'
        db.add_column(u'demo_blogpagecarouselitem', 'image_caption',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'StandardPageCarouselItem.image_title'
        db.add_column(u'demo_standardpagecarouselitem', 'image_title',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'StandardPageCarouselItem.image_caption'
        db.add_column(u'demo_standardpagecarouselitem', 'image_caption',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'HomePageCarouselItem.image_title'
        db.add_column(u'demo_homepagecarouselitem', 'image_title',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'HomePageCarouselItem.image_caption'
        db.add_column(u'demo_homepagecarouselitem', 'image_caption',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BlogPageCarouselItem.image_title'
        db.delete_column(u'demo_blogpagecarouselitem', 'image_title')

        # Deleting field 'BlogPageCarouselItem.image_caption'
        db.delete_column(u'demo_blogpagecarouselitem', 'image_caption')

        # Deleting field 'StandardPageCarouselItem.image_title'
        db.delete_column(u'demo_standardpagecarouselitem', 'image_title')

        # Deleting field 'StandardPageCarouselItem.image_caption'
        db.delete_column(u'demo_standardpagecarouselitem', 'image_caption')

        # Deleting field 'HomePageCarouselItem.image_title'
        db.delete_column(u'demo_homepagecarouselitem', 'image_title')

        # Deleting field 'HomePageCarouselItem.image_caption'
        db.delete_column(u'demo_homepagecarouselitem', 'image_caption')

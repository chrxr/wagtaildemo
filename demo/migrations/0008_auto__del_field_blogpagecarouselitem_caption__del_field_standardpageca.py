...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'BlogPageCarouselItem.caption'
        db.delete_column(u'demo_blogpagecarouselitem', 'caption')

        # Deleting field 'StandardPageCarouselItem.caption'
        db.delete_column(u'demo_standardpagecarouselitem', 'caption')

        # Deleting field 'HomePageCarouselItem.caption'
        db.delete_column(u'demo_homepagecarouselitem', 'caption')


    def backwards(self, orm):
        # Adding field 'BlogPageCarouselItem.caption'
        db.add_column(u'demo_blogpagecarouselitem', 'caption',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'StandardPageCarouselItem.caption'
        db.add_column(u'demo_standardpagecarouselitem', 'caption',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'HomePageCarouselItem.caption'
        db.add_column(u'demo_homepagecarouselitem', 'caption',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'HomePage.headline'
        db.add_column(u'demo_homepage', 'headline',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'HomePage.features'
        db.add_column(u'demo_homepage', 'features',
                      self.gf('wagtail.wagtailcore.fields.RichTextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'HomePage.headline'
        db.delete_column(u'demo_homepage', 'headline')

        # Deleting field 'HomePage.features'
        db.delete_column(u'demo_homepage', 'features')
